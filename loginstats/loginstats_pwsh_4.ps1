...
- or using the KeyboardInterrupt shortcut "Ctrl+C", and responding "y" to the prompt
...
:mainLoop while ($true) {
    ...
    # We do not need to use regular expression here, so we use -SimpleMatch
